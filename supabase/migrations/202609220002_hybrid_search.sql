...
revoke all on function public.hybrid_search(text, extensions.vector, double precision, double precision, double precision, integer) from public, anon;
grant execute on function public.hybrid_search(text, extensions.vector, double precision, double precision, double precision, integer) to authenticated;
